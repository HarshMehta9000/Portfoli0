...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
              ...
              <div className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-lg p-1 shadow-lg">
                <div className="bg-background rounded-md p-6 h-full">
                  ...
                  <div className="space-y-4">
                    <div className="card-hover p-4 rounded-md border">
                      <h4 className="font-medium">University of Wisconsin-Madison</h4>
                      <p className="text-sm text-muted-foreground">M.S. in Information (Data, ML, Cloud Focus)</p>
      ...
      {/* Gallery Section */}
      <SectionAnimation id="gallery" animation="fade" className="container py-24">
        <div className="flex flex-col items-center mb-12 text-center">
      ...
      {/* Contact Section */}
      <SectionAnimation id="contact" animation="fade" className="bg-muted/50 py-24">
