...
export default function ExperienceCardEnhanced({ experience, index }: ExperienceCardProps) {
      ...
      >
        <Card className="overflow-hidden h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
          ...
          <CardContent className="p-6 flex-grow">
            ...
            <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors">{experience.title}</h3>
          ...
          <CardFooter className="px-6 pb-6 pt-0 mt-auto">
            <div className="flex gap-2 w-full">
              ...
              <Button variant="ghost" className="px-3" onClick={() => setIsOpen(true)}>
        ...
        <DialogContent className="max-w-3xl">
          ...
          <div className="grid gap-4">
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none">
              ...
              <ul>
                {experience.content.achievements?.map((achievement, i) => <li key={i}>{achievement}</li>) || (
